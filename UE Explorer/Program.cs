        ...
        public static void LoadConfig()
        {
            ...
            if( Options.VariableTypes == null || Options.VariableTypes.Count == 0 )
            {
                Options.VariableTypes = new List<string>
                {
                    ...
                    "Engine.Actor.SupportedEvents:ObjectProperty",
                    "Engine.AnimSequence.CompressedTrackOffsets:IntProperty",
                    "Engine.AnimSet.Sequences:ObjectProperty",
                    "Engine.AnimSet.TrackBoneNames:NameProperty",
                    "Engine.BookMark.HiddenLevels:StrProperty",
                    "Engine.Brush.SavedSelections:StructProperty",
                    "Engine.DistributionFloatConstantCurve.Points:StructProperty",
                    "Engine.InterpCurveEdSetup.Tabs:StructProperty",
                    "Engine.InterpCurveEdSetup.Curves:StructProperty",
                    "Engine.InventoryManager.PendingFire:IntProperty",
                    "Engine.Material.EditorComments:ObjectProperty",
                    "Engine.Material.Expressions:ObjectProperty",
                    "Engine.Material.ReferencedTextureGuids:Guid",
                    "Engine.MaterialExpressionCustom.Inputs:StructProperty",
                    "Engine.MaterialInstanceConstant.ScalarParameterValues:StructProperty",
                    "Engine.MaterialInstanceConstant.VectorParameterValues:StructProperty",
                    "Engine.MaterialInstanceConstant.TextureParameterValues:StructProperty",
                    "Engine.MeshComponent.Materials:ObjectProperty",
                    "Engine.ObjectReferencer.ReferencedObjects:ObjectProperty",
                    "Engine.ParticleEmitter.BurstList:StructProperty",
                    "Engine.ParticleEmitter.LODLevels:ObjectProperty",
                    "Engine.ParticleLODLevel.Modules:ObjectProperty",
                    "Engine.ParticleModuleMaterialByParameter.DefaultMaterials:ObjectProperty",
                    "Engine.ParticleModuleMaterialByParameter.MaterialParameters:NameProperty",
                    "Engine.ParticleModuleMeshMaterial.MeshMaterials:ObjectProperty",
                    "Engine.ParticleModuleOrbit.LookupTable:FloatProperty",
                    ...
                    "Engine.PostProcessChain.Effects:ObjectProperty",
                    "Engine.Prefab.PrefabArchetypes:ObjectProperty",
                    ...
                    "Engine.RB_BodySetup.SphereElems:StructProperty",
                    ...
                    "Engine.SkeletalMesh.LODInfo:StructProperty",
                    "Engine.SkeletalMesh.Sockets:ObjectProperty",
                    "Engine.SkeletalMesh.TriangleSortSettings:StructProperty",
                    "Engine.SkeletalMeshComponent.AnimSets:ObjectProperty",
                    "Engine.SoundClass.ChildClassNames:NameProperty",
